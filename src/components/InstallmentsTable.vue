        ...
        <tbody class="table-group-divider">
          <template v-for="(installment, index) in installments" :key="index">
            <tr>
              ...
              <td>{{ installment.paymentDates.first && formatDate(installment.paymentDates.first) }}</td>
            </tr>
            <tr>
              ...
              <td>{{ installment.paymentDates.second && formatDate(installment.paymentDates.second) }}</td>
            </tr>
            <tr>
              ...
              <td>{{ installment.paymentDates.fourth && formatDate(installment.paymentDates.fourth) }}</td>
            </tr>
            <tr>
